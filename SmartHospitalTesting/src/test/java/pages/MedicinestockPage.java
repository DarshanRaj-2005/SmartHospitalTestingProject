...
public class MedicinestockPage {
	...
	public static By searchedmedicine = By
			.xpath("//td[text()=\"WOODWARD'S PARACETAMOL\"]/preceding-sibling::td/input[@id=\"pharmacy\"]");

	// here used dynamic xpath because if medicine change the xpath of checkbox also
	// change.
