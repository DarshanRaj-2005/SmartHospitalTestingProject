...
public class PurchaseMedicinePage {
    ...
    public static By supplierSearchBox        = By.xpath("//span[contains(@class,'select2-container--open')]//input[@type='search']");
    ...
    public static By successMessage = By.xpath(
    ...
    public static By validationMessage = By.cssSelector("div.toast-error");
    public static By csvButton                = By.cssSelector("a.buttons-csv");
