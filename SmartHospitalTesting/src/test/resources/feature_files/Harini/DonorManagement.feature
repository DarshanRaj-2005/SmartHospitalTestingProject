Feature: Donor Management Functionality
  ...
  Scenario Outline: Add donor with valid details
    ...
    When the user enters donor name "<DonorName>"
    And the user enters date of birth "<DateOfBirth>"
    And the user enters blood group "<BloodGroup>"
    And the user enters gender "<Gender>"
    And the user enters father name "<FatherName>"
    And the user enters contact number "<ContactNumber>"
